> **HISTORICAL GAP SNAPSHOT:** The older Pass245/C#/Avorion-derived sections below are reference evidence only. Current gaps are maintained in `docs/ROADMAP.md`, `docs/STATUS.md`, and `docs/audits/DEEP_PROJECT_ALIGNMENT_AUDIT_20260912.md`.
...
## Pass400 integration debt

Pass361-400 establishes the authoritative models for living orbital systems, stations, normalized GUI/context commands, galaxy navigation, PI, and fleet intent. Remaining work is primarily direct player-client integration and content/visual polish rather than parallel backend systems. Physical on-foot/interior/cutaway gameplay is no longer part of the active production direction.
