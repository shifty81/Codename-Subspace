...
string(FIND "${_r}" "std::string(\"v  \")+ShipClassRoleSystem::ClassName" _class_label)
if(_class_label EQUAL -1)
  message(FATAL_ERROR "Pass1439R1: DCC Outliner class label must concatenate through std::string.")
endif()
