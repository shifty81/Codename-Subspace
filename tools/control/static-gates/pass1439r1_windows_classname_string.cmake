...
string(FIND "${_r}" "ShipClassRoleSystem::ClassName(m.shipClass)" _class_label)
if(_class_label EQUAL -1)
  message(FATAL_ERROR "Pass1439R1: DCC class presentation must use the std::string ClassName API.")
endif()
