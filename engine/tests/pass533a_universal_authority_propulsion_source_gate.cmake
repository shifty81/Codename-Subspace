...
endforeach()
string(FIND "${RENDER}" "Compact viewport axis gizmo" forward_marker)
string(FIND "${RENDER}" "ShipyardText(\"Y\"" forward_axis_label)
if(forward_marker EQUAL -1 OR forward_axis_label EQUAL -1)
  message(FATAL_ERROR "Pass533A source gate missing compact +Y DCC axis authority")
endif()
