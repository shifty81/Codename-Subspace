...
struct InventoryItem {
    std::string itemId;
    std::string instanceId;              // stable for non-stackable generated equipment
    std::string name;
    ...
    // Pass431-450 canonical generated-item metadata. Equipment/modules remain
    // unique instances while commodities may still stack.
